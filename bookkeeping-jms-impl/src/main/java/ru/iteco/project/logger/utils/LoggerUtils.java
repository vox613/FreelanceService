...
public class LoggerUtils {
    ...
    public static final String BEFORE_CALL_PATTERN = "{} with {} - start";

    /*** Шаблон для логирования события после вызова метода**/
    public static final String AFTER_CALL_PATTERN = "{} end with result {}";

    /*** Шаблон для логирования события вызова метода**/
    public static final String CALL_PATTERN = "{} with {} - call";
